...
const user = {
  name: 'Alex Harston',
  handle: 'alexharston',
  email: 'alex@harston.io',
  imageUrl:
    'https://pbs.twimg.com/profile_images/1266472039289958403/d1AXCB1G_400x400.jpg',
}
const navigation = [
  { name: 'Home', href: 'https://ethomics.io', current: false},
  { name: 'Browse Datasets', href: 'datasets', current: false },
  { name: 'Upload Dataset', href: 'upload', current: false },
  { name: 'About', href: 'about', current: false },
  { name: 'Documentation', href: 'https://docs.ethomics.io', current: false },
  { name: 'Ethome', href: 'https://ethome.io', current: false },
]
const subNavigation = [
          ...
          <>
            <nav
              className={classNames(
                ...
                'relative z-10 border-b border-indigo-500 border-opacity-25 lg:bg-transparent lg:border-none'
              )}
            >
                      ...
                      <div className="flex">
                        {navigation.map((item) => (
                          <a
                            ...
                            href={item.href}
                            className={classNames(
                              item.current ? 'bg-black bg-opacity-25' : 'hover:bg-indigo-800',
              ...
              <form className="divide-y divide-gray-200 lg:col-span-9" action="#" method="POST">
                ...
                <div className="pt-6 divide-y divide-gray-200">
                  <div className="px-4 sm:px-6">
                    <div>
                      <h2 className="text-lg leading-6 font-medium text-gray-900">Generate API Key</h2>
                      <p className="mt-1 text-sm text-gray-500">
                      ...
                      <Switch.Group as="li" className="py-4 flex items-center justify-between">
                        <div className="flex flex-col">
                          ...
                          <Switch.Description className="text-sm text-gray-500">
                            0ca01e27-e572-47d1-9056-f00f9e2b082f
                          </Switch.Description>
                        </div>
                        <Switch
