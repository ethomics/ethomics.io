...
const navigation = [
  { name: 'Home', href: 'https://ethomics.io', current: true },
      ...
      <div className="min-h-full">
        ...
        <header className="bg-white shadow-sm">
          <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
            <h1 className="text-3xl leading-6 mb-3 font-semibold text-indigo-700 pt-8">ethomics.io</h1>
            <h2 className="text-xl leading-3 font-medium text-gray-500 pt-2 pb-8">A repository for behavioural datasets</h2>
            <StatsSection/>
